...
nuevoArray.push(elArray[elArray.length-1]); // adds last point into array
...
//function calculates checkpoint on the softing curve 
...
//CREATES CURVE TO CONNECT POINTS
...
function redibujarTrazados(){
    dibujar = false;
    ctx.clearRect(0,0,cw,ch); // CLEANS CANVAS
    reducirArray(factorDeAlisamiento,puntos); //REDUCE POINTS AMOUNT
    Trazados.forEach(trazado => alisarTrazado(trazado)); // SOFTEN AND REDRAWS TRACES
}
